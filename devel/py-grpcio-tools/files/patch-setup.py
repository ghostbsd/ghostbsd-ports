--- setup.py.orig	2026-07-08 09:16:27 UTC
+++ setup.py
@@ -196,7 +196,7 @@ if EXTRA_ENV_COMPILE_ARGS is None:
...
@@ -229,7 +229,7 @@ if EXTRA_ENV_LINK_ARGS is None:
...
@@ -269,7 +269,7 @@ if "win32" in sys.platform:
     )
